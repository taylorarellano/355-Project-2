...
exports.getById = function(title, callback) {
    var query = 'SELECT * FROM tv WHERE title = ?';
    var queryData = [title];
...
exports.insert = function(params, callback) {
    var query = 'INSERT INTO tv (title, height, gender, age) VALUES (?, ?, ?, ?)';
...
exports.delete = function(title, callback) {
    var query = 'DELETE FROM tv WHERE title = ?';
    var queryData = [title];
...
exports.update = function(params, callback) {
    var query = 'UPDATE tv SET title = ?, genres = ?, year = ?, director = ?, book_title = ? WHERE title = ?';
